...
document.addEventListener('DOMContentLoaded', () => {
	const player = new Plyr('#video-reel', {
		title: 'Reel Rabanito',
		fullscreen:{ enabled: true}
	}); 
});

$(".col-caja").on( "mouseover", function() {
	$(".mensaje-caja").removeClass("d-none");
});
$(".col-caja").on( "mouseleave", function() {
	$(".mensaje-caja").addClass("d-none");
});
...
//end funcion antes y despues

// cambiar img on click doble exposicion AAASJFJAAJKTE ODIO CHAT GPT
...
$('#vintage').on("click", function () {
	$('#vintageModal').modal('show');
});

$('#dobleexposicion').on("click", function () {
	$('#dobleexposicionModal').modal('show');
});

$('#monsterinc').on("click", function () {
	$('#monsterincModal').modal('show');
});
...
$('#holamundo').on("click", function () {
	$('#holamundoModal').modal('show');
});

$('#caramelos').on("click", function () {
	$('#caramelosModal').modal('show');
});

$('#vueltaalmundo').on("click", function () {
	$('#vueltaalmundoModal').modal('show');
});

$('#alfombra').on("click", function () {
	$('#alfombraModal').modal('show');
});

$('#skatebici').on("click", function () {
	$('#skatebiciModal').modal('show');
});
